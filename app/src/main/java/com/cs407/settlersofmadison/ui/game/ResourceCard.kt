...
fun ResourceCard(
    ...
    val icon = when (res.type) {
        Resource.BRICK -> R.drawable.brick
        Resource.WHEAT -> R.drawable.wheat
        Resource.ORE   -> R.drawable.ore
        Resource.SHEEP -> R.drawable.sheep
        Resource.WOOD  -> R.drawable.wood
    }
...
@Composable
private fun Preview_ResourceCard() {
    ResourceCard(
        res = ResourceCount(Resource.BRICK, 3)
    )
}
